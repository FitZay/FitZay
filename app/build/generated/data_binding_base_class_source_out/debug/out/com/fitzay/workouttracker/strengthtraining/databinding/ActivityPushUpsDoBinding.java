...
public final class ActivityPushUpsDoBinding implements ViewBinding {
  ...
  private ActivityPushUpsDoBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ConstraintLayout clAds, @NonNull ConstraintLayout clBottomNext,
      @NonNull ConstraintLayout clLess5, @NonNull AppCompatButton cta, @NonNull ImageView img001,
      @NonNull ImageView iv1529Checked, @NonNull ImageView iv30, @NonNull ImageView ivBack,
      @NonNull ImageView ivLess5Checked, @NonNull RelativeLayout layoutAd,
      ...
      @NonNull TextView text001, @NonNull MaterialTextView tv1529, @NonNull MaterialTextView tv30,
  ...
  public static ActivityPushUpsDoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPushUpsDoBinding((ConstraintLayout) rootView, btnNext, cl1529, cl30,
          cl629Week, clAds, clBottomNext, clLess5, cta, img001, iv1529Checked, iv30, ivBack,
          ivLess5Checked, layoutAd, materialToolbar, plannerTemplateDown, plannerTemplateUp,
          skeletonLayout, text001, tv1529, tv30, tv629, tv629Checked, tvLess5, tvQuestion);
    }
