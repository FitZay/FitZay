...
public final class ActivityBmiBinding implements ViewBinding {
  ...
  private ActivityBmiBinding(@NonNull ConstraintLayout rootView, @NonNull TextView ageH,
      ...
      @NonNull ConstraintLayout clBottomNext, @NonNull AppCompatButton cta, @NonNull TextView des,
      @NonNull TextView finalVal, @NonNull TextView heightH, @NonNull TextView heightValue,
      @NonNull ImageView img001, @NonNull RelativeLayout layoutAd, @NonNull View line,
      @NonNull TextView mainT, @NonNull View mainV, @NonNull TemplateView plannerTemplateDown,
      @NonNull TemplateView plannerTemplateUp, @NonNull TextView profile,
      @NonNull SkeletonRelativeLayout skeletonLayout, @NonNull TextView text001,
      @NonNull TextView weightH, @NonNull TextView weightValue) {
  ...
  public static ActivityBmiBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBmiBinding((ConstraintLayout) rootView, ageH, ageValue, back, bmiExtreme,
          bmiLow, bmiNormal, bmiObese, bmiOverweight, bmiValue, bmiloader, btnNext, clAds,
          clBottomNext, cta, des, finalVal, heightH, heightValue, img001, layoutAd, line, mainT,
          mainV, plannerTemplateDown, plannerTemplateUp, profile, skeletonLayout, text001, weightH,
          weightValue);
    }
