...
public abstract interface StepDao {
    ...
    @androidx.room.Query(value = "SELECT * FROM Step ORDER BY id DESC")
    public abstract java.util.List<com.fitzay.workouttracker.strengthtraining.data.model.Step> getPaging();
