...
public final class ExtentionKt {
    ...
    @org.jetbrains.annotations.NotNull
    public static final java.lang.String getSimpleDate2(@org.jetbrains.annotations.NotNull
    android.content.Context $this$getSimpleDate2) {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull
    public static final java.lang.String getDayOfWeekName(@org.jetbrains.annotations.NotNull
    android.content.Context $this$getDayOfWeekName, @org.jetbrains.annotations.NotNull
    java.util.Date date) {
        return null;
    }
    ...
    android.content.Context $this$setLocale, @org.jetbrains.annotations.Nullable
    android.content.Context context, @org.jetbrains.annotations.NotNull
    java.lang.String lang) {
    }
    
    private static final android.content.Context updateBaseContextLocale(android.content.Context context, java.lang.String language) {
        return null;
    }
    
    private static final android.content.Context updateResourcesLocale(android.content.Context context, java.util.Locale locale) {
        return null;
    }
    
    private static final android.content.Context updateResourcesLocaleLegacy(android.content.Context context, java.util.Locale locale) {
        return null;
    }
    
    public static final float calculateBMI(@org.jetbrains.annotations.NotNull
    android.content.Context $this$calculateBMI, int height, int weight) {
        return 0.0F;
    }
}