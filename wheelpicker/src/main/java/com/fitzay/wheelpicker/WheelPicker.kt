package com.fitzay.wheelpicker
...
import com.app.wheelpicker.R
import com.app.wheelpicker.databinding.PickerWheelBinding
...
class WheelPicker@JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, @AttrRes defStyleAttr: Int = 0) : FrameLayout(context, attrs, defStyleAttr) {
    ...
    private var wheelPickerAdapter: WheelItemAdapter? = null
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        if (properties.orientation == LinearLayout.VERTICAL) {
    ...
    private fun initWheelPicker() {
        ...
        // Adapter
        wheelPickerAdapter = WheelItemAdapter(context, properties, object: OnWheelPickerListener {
            override fun onItemSelected(position: Int, value: String) {
                properties.scrolling = false
